  	...
  	deployer.deploy(Controller).then(
  		async function(instance){
	  		...
	  		await deployer.deploy(RestaurantFactory,instance.address).then(async function(restaurantFactInstance){
				...
				await restaurantFactInstance.createRestaurant( "0x47656f726765277320546573742052657374617572616e74","0x46616b65204164647265737320537472656574",200,300,"0x30313233343536373839",{gas: 4000000}).then(async function(){
