...
module.exports = function(deployer) {	
	// for deploying everything
	  ...
	  // 		var restFactAddress;
	  // 		await deployer.deploy(RestaurantFactory,instance.address,{gas: 1000000000000}).then(async function(restaurantFactInstance){
  	...
  	deployer.deploy(Menu, "0x7DcD6B2EBc56C69dD6ee17f7CdCa82149e13e4E3");
