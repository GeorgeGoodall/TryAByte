...
contract Customer {
    ...
    function makeOrder(address payable restaurant, uint[] calldata items, uint deliveryFee) external payable returns (address orderAddress){
        ...
        address orderAddr = Restaurant(restaurant).makeOrder.value(price + deliveryFee)(items, deliveryFee);
